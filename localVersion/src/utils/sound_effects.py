...
class SoundEffects():
    ...
    def __init__(self) -> None:
        self.sounds = {
            'click': self.load_sound("localVersion/utils/sound_effects/click.wav"),
            'win': self.load_sound("localVersion/utils/sound_effects/win.wav"),
            'lose': self.load_sound("localVersion/utils/sound_effects/error.wav"),
